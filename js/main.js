...
ScrollReveal().reveal('.home-image, .about-img', {delay: 500, origin: 'bottom' });
ScrollReveal().reveal('.about .description, .contact-right', { delay: 600, origin: 'right' });
ScrollReveal().reveal('.about .proffesional-list li', { delay: 500, origin: 'right', interval: 200 });
...
ScrollReveal().reveal('.experience-card, .service-card, .education, .portfolio .img-card', { delay: 800, origin: 'botton', interval: 200 });
